...
class Object3d(object):
    def __init__(self, line):
        ...
        self.src = line
        class_3d_str = label[0]
        if class_3d_str == 'car':
            self.cls_type = 'Car'
        elif class_3d_str == 'truck':
            self.cls_type = 'Truck'
        elif class_3d_str == 'small_car':
            self.cls_type = 'Car'
        elif class_3d_str == 'big_car':
            self.cls_type = 'Truck'
        else:
        ...
        self.rx,self.ry,self.rz = [float(t) for t in label[14:17]]
        self.p_x, self.p_y = [float(t) for t in label[17:19]]
        self.keypoints = [float(t) for t in label[19:119]]
        self.visible = [float(t) for t in label[119:139]]
